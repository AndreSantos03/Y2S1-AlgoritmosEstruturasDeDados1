...
void Student::get_schedule(string studentCode)
{
    ...
    for (int i = 0; i < student.classes_new.size(); i++)
    {
        ...
        {
            r_vector.push_back({student.classes_new.at(i).UcCode, student.classes_new.at(i).ClassCode, student.classes_new.at(i).WeekDay, student.classes_new.at(i).StartHour, student.classes_new.at(i).Duration, student.classes_new.at(i).Type});
        }
    }
